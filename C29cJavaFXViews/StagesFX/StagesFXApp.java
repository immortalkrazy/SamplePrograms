...
public class StagesFXApp extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		decoratedStage.getIcons().add(new Image("images/cat.png"));
		decoratedStage.show();
		...
		undecoratedStage.getIcons().add(new Image("images/cat.png"));
		...
		transparentStage.getIcons().add(new Image("images/cat.png"));
		...
		utilityStage.getIcons().add(new Image("images/cat.png"));
		utilityStage.show();
		...
		appModalStage.getIcons().add(new Image("images/cat.png"));
		appModalStage.show();
	}
}
